...
if [[ ! -L /var/vcap/packages/apache2/conf/httpd.conf ]]
then
  rm /var/vcap/packages/apache2/conf/httpd.conf
  ln -s /var/vcap/jobs/httpd/conf/httpd.conf /var/vcap/packages/apache2/conf/httpd.conf
  mkdir /var/vcap/packages/apache2/conf/vhosts
  ln -s /var/vcap/jobs/httpd/conf/vhosts/artifactory.conf /var/vcap/packages/apache2/conf/vhosts/artifactory.conf
fi
